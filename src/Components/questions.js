...
const questions = [
    ...
    },
    {
        ...
        answerOptions: [
            { answerText: 'Cleaning the dishes', isCorrect: false, submitText: "I know you're not in the mood for that right now " },
            ...
            { answerText: 'Vaccuming', isCorrect: true, submitText: "Now that's the right answer babe, wouldn't want anyone else in the world to be stuck then you <3"  },
        ],
        rewardCardImage: starbucks,
        rewardTitle: 'Starbucks',
        claimCode: '0000000000',
    ...
    },
    {
        ...
        answerOptions: [
            ...
            { answerText: 'Beyonce', isCorrect: false, submitText: "She is taken by Jay Z, that's not nice, try again princess." },
            { answerText: 'Shakira', isCorrect: false, submitText: "Way too old for me and I don't do FOBS you know that lol, try again cutie." },
            { answerText: 'Strawberry', isCorrect: true, submitText: "Now that's the right answer babe, wouldn't want anyone else in the world to be stuck then you <3"  },
        ],
        rewardCardImage: starbucks,
        rewardTitle: 'Starbucks',
        claimCode: '0000000000',
